<template>
  <nav
    ...
    <div>
      ...
      <span v-if="user" class="text-white font-bold mr-8">Welcome <span class="font-normal">{{ user.displayName }}</span></span >
      ...
      <button v-if="user" class="p-2 mx-1 hover:text-purple-900 hover:bg-gray-300"
        @click="logOut">
        Logout
      </button>
      <router-link
